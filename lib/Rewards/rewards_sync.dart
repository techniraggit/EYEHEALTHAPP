...
class _RewardsContactsSync extends State<RewardContact> {
  ...
  void shareAppLink(int i) async {
    try {
      ...
      String imagePath =
          '${tempDir.path}/banner1.png'; // Adjust the file name as needed
      ...
      if (!fileExists) {
        ...
        ByteData imageData = await rootBundle.load(
            'assets/banner1.png'); // Replace 'banner1.png' with your image asset path
        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              content: Text(
                  "SMS permissions are permanently denied. Please go to app settings to enable location permissions."),
              actions: <Widget>[
                ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors
        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              content: Text(
                  "contacts permissions are permanently denied. Please go to app settings to enable contacts permissions."),
              actions: <Widget>[
                ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors
