...
class TestReportState extends State<TestReport> {
  ...
  String left_eye="a",left_sph="b",left_cyl="c",left_axis="d",left_add="a",name="a",age="a";
  String right_eye="a",right_sph="a",right_cyl="a",right_axis="a",right_add="a";
  ...
  Future<void> GenerateReport() async {
    ...
    String test_id=id;
    final String apiUrl = '${Api.baseurl}/api/eye/generate-report?test_id=$test_id';
                    ...
                    Container(
                      ...
                      child: const Row(
                        ...
                        children: <Widget>[
                          Text(
                              'Full name',
                              style: TextStyle(fontSize: 16, color: Color(0xFF1E3777))),
                          Text(
                            'Age',
                            style: TextStyle(fontSize: 16, color: Color(0xFF1E3777)),
                          ),
                    ...
                    Container(
                      ...
                      child: Center(
                        child: ElevatedButton(
                          ...
                          child: Text('Exit',   style: TextStyle(fontSize: 16), // Adjust text size here
                          ),
                        ),
                      ),
                    )
