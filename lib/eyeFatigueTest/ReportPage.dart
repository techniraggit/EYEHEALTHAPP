            ...
            buildOtherReport(context),
                  ...
                  floatingActionButton: Padding(
                    ...
                    child: ClipOval(
                      child: Material(
                        color:
                            Colors.white70.withOpacity(0.9), // Background color
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Card(
                        ...
                        child: Container(
                          padding:
                              EdgeInsets.symmetric(horizontal: 2, vertical: 11),
                          child: ListTile(
                            title: Column(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Text(
                            'No test is done yet... please do digital eye test first',
                            // Display formatted current date
            ...
            children: <Widget>[
              ...
              ElevatedButton.icon(
                style: ElevatedButton.styleFrom(
                  ...
                  // Text style of the button label
